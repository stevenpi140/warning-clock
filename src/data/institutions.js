...
const institutions = [
  {
    ...
    impact: [
      ...
      '《憲訴法》惡修已經 114 年憲判字第 1 號宣告違憲失效、憲法法庭重啟；惟大法官仍長期缺額，若提名持續遭杯葛、現額隨任期屆滿逐年流失，憲法法庭恐再陷不足額而難以穩定運作。',
    ],
    timeline: [
      ...
      { date: '2027/09/30', text: '謝銘洋等 4 位大法官任期屆滿，須及時提名補足' },
    ],
    sources: [
  ...
  },
  {
    ...
    keyFact:
      '2025 年度總預算刪減監察院業務費高達 96%，調查、巡察、議事、國際監察及人權業務預算近乎全刪；本屆監委 2026/7/31 屆滿，藍白揚言全數否決提名並廢除監察院，恐使其陷於癱瘓。',
    keyFactEn:
    ...
    actions: [
      '惡意刪減預算：2025 年度刪減監察院業務費達 96%，一般行政、調查巡察、議事、國際監察及人權業務預算近乎全刪。',
    ...
    timeline: [
      { date: '2025', text: '立法院刪減監察院 2025 年度業務費達 96%' },
      { date: '2026/06/11', text: '總統府公布監察院第 7 屆正、副院長及監察委員被提名人' },
      { date: '2026/07/31', text: '本屆監察委員任期屆滿，恐遭藍白全數否決' },
    ],
    sources: [
      { label: '監察院官網：2025 年度業務費遭刪逾 96%，將聲請釋憲及暫時處分', url: 'https://www.cy.gov.tw/News_Content.aspx?n=124&s=32763' },
  ...
  },
  {
    ...
    actions: [
      ...
      '限縮代理：藍白提《法院組織法》第 66 條修正，增訂「未獲立法院同意者不得代理」、每人限代理一次，代理期限國民黨版不得逾六個月、民眾黨版更限三個月，意在壓縮代理檢察總長之存續與職權空間。',
    ],
    impact: [
  ...
  },
  {
    ...
    status: 'former',
    statusLabel: '曾停擺半年・已復會',
    totalSeats: 11,
    vacantSeats: 3,
    criticalDate: null,
    org: '依《中央選舉委員會組織法》置委員 9-11 人（含主委、副主委各 1）；依《中央選舉委員會會議規則》第 5 條，全體委員及委員總額以「現有委員人數」為計算標準，故現有委員即達開會門檻，得召開委員會議並作成決議。',
    keyFact:
      '原 6 名委員（含主委李進勇）2025/11/3 任期屆滿卸任後僅餘 4 人，中選會停擺約半年；2026/3/13 立法院通過游盈隆等 4 人、否決胡博硯等 3 人（迄今唯一一次部分否決），游盈隆 4/27 就任、5/15 主持首次委員會議恢復運作。現有 8 名委員雖低於法定下限 9 人、副主委仍從缺，依《會議規則》以現有委員人數計算已達開會門檻、得作成決議；真正考驗在 2027/11/3 另 4 名委員任期屆滿。',
    keyFactEn:
      'Six commissioners’ terms expired on 3 Nov 2025, leaving only four and stalling the Commission for about six months. On 13 Mar 2026 the Legislature confirmed four nominees but rejected three; after delayed appointments, chair Yu Ying-lung took office on 27 Apr and convened the first commission meeting on 15 May, restoring operations. The current eight members sit below the statutory minimum of nine, yet meet the quorum counted on current membership; the real test comes when four more terms expire on 3 Nov 2027.',
    actions: [
      '部分否決提名（迄今唯一一次）：行政院提名 7 人，立法院於 2026/3/13 僅通過游盈隆、李禮仲、蘇嘉宏、蘇子喬 4 人，否決副主委被提名人胡博硯及委員黃文玲、陳宗義 3 人；行政院批藍白未守協商誠信，致中選會委員缺額、副主委至今從缺。',
    ],
    impact: [
      '2025/11/3 起至 2026/5/15 復會前約半年無法召開委員會議與作成決議，曾影響選務、公投及罷免等法定事項之推進。',
      '雖已恢復開會，現有 8 名委員仍低於法定下限 9 人、副主委從缺，遇重大爭議或多項公投案須較高出席門檻時仍顯脆弱；2027/11/3 另 4 名委員（黃秀端、陳月端、吳容輝、游清鑫）任期屆滿，將是下一道難關。',
    ],
    timeline: [
      { date: '2025/11/03', text: '李進勇等 6 名委員任期屆滿卸任，僅餘 4 人、無法召開委員會議' },
      { date: '2026/03/13', text: '立法院通過游盈隆等 4 人、否決胡博硯等 3 人（唯一一次部分否決）' },
      { date: '2026/04/27', text: '游盈隆就任主委（4/21 派令遲發、張惇涵監交）' },
      { date: '2026/05/15', text: '游盈隆主持首次委員會議，停擺約半年後恢復運作' },
      { date: '2026/07/03', text: '立法院表決補提名沈淑妃、蔡維哲、黃謀信 3 人' },
      { date: '2027/11/03', text: '另 4 名委員任期屆滿，須及早提名補足' },
    ],
    sources: [
      { label: '中央社：游盈隆任中選會主委 胡博硯等 3 人遭立院否決（2026/3/13）', url: 'https://www.cna.com.tw/news/aipl/202603130156.aspx' },
      { label: '聯合報：游盈隆 4/27 接掌中選會 張惇涵監交', url: 'https://udn.com/news/story/6656/9461742' },
      { label: '聯合報：中選會空轉 6 個月終於開會 財產申報系統 8/27 上線（2026/5/15 復會）', url: 'https://udn.com/news/story/124652/9505473' },
      { label: '中選會主管法規系統：中央選舉委員會會議規則第 5 條（門檻以現有委員人數計算）', url: 'https://law.cec.gov.tw/LawContent.aspx?id=GL000302' },
  ...
  },
  {
    ...
    vacantSeats: 4,
    criticalDate: null,
    elapsedSince: '2024-11-30',
    elapsedSinceLabel: '自 2024/11/30 委員不足額',
    org: '依《國家通訊傳播委員會組織法》置委員 7 人，決議應以委員總額過半數（4 人）之同意行之；NCC 為通訊傳播事務之獨立管制機關。',
    keyFact:
      '2024/11/30 代理主委翁柏宗因延任條款遭刪除卸任後，NCC 7 名委員僅餘 3 人、未達委員總額過半數（4 人）之決議門檻，自此無法召開法定委員會議，已持續癱瘓逾一年半；逾百項重大業務無法決議，僅能以不具決議效力的諮議會議授權主委處理約 58 項基本業務。現有委員王正嘉、王怡惠、陳崇樹 2026/7/31 同時屆滿，若提名續遭封殺恐全面團滅。',
    keyFactEn:
      'Since acting chair Weng Po-tsung left on 30 Nov 2024 the NCC has had only 3 of 7 members, short of the four-vote majority any resolution requires, and has been unable to hold a lawful commission meeting for over a year and a half; more than a hundred major items remain undecidable. The three remaining members’ terms all end 31 July 2026, risking a total wipeout.',
    actions: [
    ...
    impact: [
      'NCC 自委員不足額後，逾百項重大業務無法決議，僅約 58 項基本業務得授權主委召集諮議會議處理。',
      '現有委員王正嘉、王怡惠、陳崇樹 2026/7/31 同時屆滿，若提名續遭封殺，3 名委員將全體卸任、NCC 形同團滅。',
    ],
    timeline: [
      { date: '2024/11/30', text: '翁柏宗卸任，NCC 委員僅餘 3 人、不足決議門檻' },
      { date: '2025/07/31', text: '行政院提名蔣榮先等 4 名委員' },
      { date: '2025/11/07', text: '立法院藍白全體否決 4 名提名人' },
      { date: '2026/07/31', text: '現有 3 名委員任期同時屆滿，恐全面團滅' },
    ],
    sources: [
      { label: '中央社：NCC 被提名人全遭否決（2025/11/07）', url: 'https://www.cna.com.tw/news/aipl/202511070091.aspx' },
